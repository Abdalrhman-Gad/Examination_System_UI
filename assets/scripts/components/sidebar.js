...
export function renderSidebar(mainContent) {
  ...
  <div class="sidebar-container w-100 vh-100">
        ...
        <div class="d-flex sidebar d-flex flex-column justify-content-center 
            ...
            <a id="add-qst" href="#/addquestion" class="text-white py-3 fs-5 text-center w-100" data-link>Add Question</a>
  ...
  document.getElementById("add-qst").addEventListener("click", (e) => {
    e.preventDefault();
    window.location.hash = "#/addquestion";
  });
}
